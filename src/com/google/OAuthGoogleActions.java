...
/**
 * Servlet implementation class OAuthGoogleActions
 */
@WebServlet("/OAuthGoogleActions")
public class OAuthGoogleActions extends HttpServlet {
   ...
   private static String googleActionsRedirectURI = "https://oauth-redirect.googleusercontent.com/r/sos-services-2604b?code=ACCESS_TOKEN_VALUE&state=";
   protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (null != refresh_token) {//Step 3
		 ...
		 if (null != code) {//Step 2. get access token from auth code
			...
			if (null != state ) {
				...
				System.out.println(" getting access and refresh token response from DB : "+loginVOStr);
				Gson  json = new Gson();
	...
	private void getAuthCode(HttpServletRequest request, HttpServletResponse response, String client_id, String state){
		//Client id + redirect url + scope + response type
			...
			String redirectUrl = "https://accounts.google.com/o/oauth2/auth?response_type=code&scope=https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.email%20https%3A%2F%2Fwww.googleapis.com%2Fauth%2Fuserinfo.profile&client_id="+client_id+"&state="+state+"&redirect_uri=https%3A%2F%2Fsosservices.appspot.com%2FOAuthGoogleActions&output=embed";
			try {
	...
	private  Map<String,Object> getAccesstoken(HttpServletRequest request, HttpServletResponse res, String code, String client_id) throws IOException{
		...
		String urlParameters  = "grant_type=authorization_code&client_id="+client_id+"&client_secret="+client_secret+"&redirect_uri=https%3A%2F%2Fsosservices.appspot.com%2FOAuthGoogleActions&code="+code+"&output=embed";
